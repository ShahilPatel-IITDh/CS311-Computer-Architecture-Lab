public class infiltrator extends sensor 
{
    ...
    //moves the infiltrator in border area.
    public void Move(){
        // board.l = 1000;
        while((x<=5000 && x!=0) && (y<=w && y>=0))
        {
            ...
            sens.p = p;
            sens.Create();
            if(sens.board.border[1][1]==0)
            {
                if(y<w-1 && x<999){
                    if(sens.board.border[2][2]==0){
                        x+=1;
                        y+=1;
                    }
                }
                ...
                if(y>0){
                    if(x<999){
                        if(sens.board.border[2][0]==0){
                            x+=1;
                            y-=1;
                        }
                    }
                    if(sens.board.border[1][0]==0){
                        y-=1;
                    }
                    if(x>0){
                        if(sens.board.border[0][0]==0){
                            x-=1;
                            y-=1;
                        }
                    }
                ...
                if(x>0){
                    if(sens.board.border[0][1]==0){
                        x-=1;
                    }
                }
                if(y<w-1){
                    if(x>0){
                        if(sens.board.border[0][2]==0){
                            x-=1;
                            y+=1;
                        }
                        if(sens.board.border[1][2]==0){
                            y+=1;
                        }
                    }
                }
